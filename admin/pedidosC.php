...
inner join usuario on ventas.id_usuario=usuario.id where ventas.id_usuario='". $arregloUsuario['id_usuario']."'
  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="content-wrapper" style="background:#FDF1DB"><br>
        ...
        <div class="content-header">
            <h1 class="m-0" style="text-align:center;color:#84253E;font-weight: bold;" >Mis Pedidos</h1>
        </div><br>
    ...
    <section class="content">
      ...
      <table class="table table-striped">
        <thead style="background:#C3F584;color:white">
          <tr>
            <th>ID Venta</th>
