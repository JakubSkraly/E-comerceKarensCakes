  ...
  <div class="content-wrapper" style="background:#FDF1DB">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0" style="color:#84253E;font-weight: bold;">Cupones</h1>
          </div><!-- /.col -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group" >
                 ...
                 <input type="number" name="valor" placeholder="valor" id="valor" class="form-control" required>
               </div>
               <div class="form-group" >
            ...
            <div class="modal-body">
              <input type="hidden" id="idEdit" name="id">
               ...
               <div class="form-group" >
                 ...
                 <input type="number" name="precio" placeholder="precio" id="precioEdit" class="form-control" required>
               </div>
               <div class="form-group" >
