...
$resultado =$conexion->query("select * from usuario")or die($conexion->error);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background:#FDF1DB">
    ...
    <div class="content-header">
            ...
            <h1 class="m-0" style="text-align:center;color:#84253E;font-weight: bold;">Usuarios</h1>
    ...
    <section class="content">
      ...
      <table class="table table-striped">
        <thead style="background:#A6CB12;color:white">
          <tr>
            <th>ID</th>
            <th>Nombre</th>
            <th>Telefono</th>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <input type="hidden" id="idEdit" name="id">
               ...
               <div class="form-group" >
                 <label for="inventarioEdit">Nivel </label>
                 <select name="nivel" id="nivelEdit" class="form-control">
